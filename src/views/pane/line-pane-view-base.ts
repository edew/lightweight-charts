...
export abstract class LinePaneViewBase<TSeriesType extends 'Line', ItemType extends PricedValue & TimedValue> extends SeriesPaneViewBase<TSeriesType, ItemType> {
